// From
// https://github.com/SpinalHDL/SaxonSoc/blob/dev-0.1/software/standalone/driver/riscv.h
//
...
#define csr_swap(csr, val)                                                     \
  ({                                                                           \
    ...
    __asm__ __volatile__("csrrw %0, " #csr ", %1" : "=r"(__v) : "rK"(__v));    \
    __v;                                                                       \
  })
...
#define csr_read_set(csr, val)                                                 \
  ({                                                                           \
    unsigned long __v = (unsigned long)(val);                                  \
    __asm__ __volatile__("csrrs %0, " #csr ", %1" : "=r"(__v) : "rK"(__v));    \
    __v;                                                                       \
  })
...
#define csr_read_clear(csr, val)                                               \
  ({                                                                           \
    unsigned long __v = (unsigned long)(val);                                  \
    __asm__ __volatile__("csrrc %0, " #csr ", %1" : "=r"(__v) : "rK"(__v));    \
    __v;                                                                       \
  })
